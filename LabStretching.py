...
from relative_stretchingL import Relative_stretching
from relative_stretching_ab import Relative_stretching_ab
...
def  LABStretching(sceneRadiance):
    ...
    img_L_stretching = Relative_stretching(L, height, width)
    img_a_stretching = Relative_stretching_ab(a, height, width)
    img_b_stretching = Relative_stretching_ab(b, height, width)
